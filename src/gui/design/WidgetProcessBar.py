...
"            ")
        ...
        self.GraphLayoutWidget.setMinimumSize(QSize(100, 0))
        self.GraphLayoutWidget.setMaximumSize(QSize(100, 16777215))
        ...
        self.VideoFrameLabel.setMinimumSize(QSize(100, 56))
        self.VideoFrameLabel.setMaximumSize(QSize(100, 56))

        self.GraphLayout.addWidget(self.VideoFrameLabel)


        self.horizontalLayout_2.addWidget(self.GraphLayoutWidget, 0, Qt.AlignTop)
