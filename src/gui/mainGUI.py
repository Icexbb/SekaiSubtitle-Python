...
class Ui_Sekai_Subtitle(object):
    def setupUi(self, Sekai_Subtitle):
        ...
        self.subtitle_combo_type.addItem("")
        self.subtitle_combo_type.addItem("")
        self.subtitle_combo_type.addItem("")
        self.subtitle_combo_type.addItem("")
        ...
        self.subtitle_combo_source.setMaximumSize(QSize(100, 22))
        ...
        self.subtitle_combo_episode.setMaximumSize(QSize(100, 22))
    ...
    def retranslateUi(self, Sekai_Subtitle):
        ...
        self.subtitle_combo_json_source.setItemText(1, QCoreApplication.translate("Sekai_Subtitle", u"\u81ea\u52a8\u83b7\u53d6\uff1apjsek.ai", None))
        self.subtitle_combo_json_source.setItemText(2, QCoreApplication.translate("Sekai_Subtitle", u"\u81ea\u52a8\u83b7\u53d6\uff1asekai.best", None))

        self.subtitle_button_json_load.setText(QCoreApplication.translate("Sekai_Subtitle", u"\u8f7d\u5165", None))
        self.subtitle_combo_type.setItemText(0, QCoreApplication.translate("Sekai_Subtitle", u"\u4e3b\u7ebf\u5267\u60c5", None))
        self.subtitle_combo_type.setItemText(1, QCoreApplication.translate("Sekai_Subtitle", u"\u6d3b\u52a8\u5267\u60c5", None))
        self.subtitle_combo_type.setItemText(2, QCoreApplication.translate("Sekai_Subtitle", u"\u7279\u6b8a\u5267\u60c5", None))
        self.subtitle_combo_type.setItemText(3, QCoreApplication.translate("Sekai_Subtitle", u"\u5361\u9762\u5267\u60c5", None))
